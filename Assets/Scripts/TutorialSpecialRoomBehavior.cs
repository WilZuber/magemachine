...
public class TutorialSpecialRoomBehavior : MonoBehaviour, IDeathListener
{
    ...
    private void SpawnEnemies()
    {
        ...
        GameObject newEnemy = Object.Instantiate(enemy, gameObject.transform);
        newEnemy.GetComponent<HealthManager>().deathListener = this;
